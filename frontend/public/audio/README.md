...
2. `hindi-two.mp3` - Say: "दो" (Do)
3. `hindi-three.mp3` - Say: "तीन" (Teen)

## Audio Format:
- Format: MP3
- Recommended bitrate: 128 kbps or higher
- Duration: 2-5 seconds per word/phrase
- Clear pronunciation, medium speed
- No background music

## How to Add Audio:
1. Record or obtain the audio files
2. Save them with the exact names listed above
3. Place them in this `/public/audio/` folder
4. Refresh your browser - the audio will automatically work!

## Note:
If audio files are not found, the system automatically uses text-to-speech as a fallback.
