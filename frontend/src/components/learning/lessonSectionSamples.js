      ...
      interactions: [
        {
          ...
          questionImageUrl: '/images/friendly-greeting.svg',
          questionAudioUrl: '/audio/greet-s2-1-question.mp3',
          options: ['Hi!', 'Go away!', 'Not now.'],
          correctAnswer: 'Hi!',
          hint: 'Choose the warm and welcoming word.',
          explanation: '"Hi!" is a friendly and casual greeting.',
          explanationAudioUrl: '/audio/greet-s2-1-explanation.mp3',
          maxAttempts: 3,
          timeLimitSeconds: 25,
          feedback: {
            correct: 'Perfect! "Hi!" is very friendly.',
            correctAudioUrl: '/audio/greet-s2-1-correct.mp3',
            incorrect: 'Try again. Pick the warmest greeting.',
            incorrectAudioUrl: '/audio/greet-s2-1-incorrect.mp3',
          },
          position: 0,
        },
        {
          ...
          questionImageUrl: '/images/smiling-person.svg',
          questionAudioUrl: '/audio/greet-s2-2-question.mp3',
          correctAnswer: 'True',
          hint: 'A smile makes people feel welcome.',
          explanation: 'Smiling when greeting makes you appear friendly and approachable.',
          explanationAudioUrl: '/audio/greet-s2-2-explanation.mp3',
          maxAttempts: 3,
          timeLimitSeconds: 25,
          feedback: {
            correct: 'Exactly! A smile makes greetings warmer.',
            correctAudioUrl: '/audio/greet-s2-2-correct.mp3',
            incorrect: 'Think about what makes people feel welcome.',
            incorrectAudioUrl: '/audio/greet-s2-2-incorrect.mp3',
          },
          position: 1,
        },
        {
          ...
          questionImageUrl: '/images/asking-friendly.svg',
          questionAudioUrl: '/audio/greet-s2-3-question.mp3',
          correctAnswer: 'How are you',
          hint: 'Ask about their well-being.',
          explanation: '"How are you?" shows you care about the person.',
          explanationAudioUrl: '/audio/greet-s2-3-explanation.mp3',
          maxAttempts: 3,
          timeLimitSeconds: 35,
          feedback: {
            correct: 'Great question! That\'s very friendly.',
            correctAudioUrl: '/audio/greet-s2-3-correct.mp3',
            incorrect: 'Try asking "How are you?"',
            incorrectAudioUrl: '/audio/greet-s2-3-incorrect.mp3',
          },
          position: 2,
        },
      ],
      ...
      interactions: [
        {
          ...
          questionImageUrl: '/images/store.svg',
          questionAudioUrl: '/audio/vocab-s2-1-question.mp3',
          options: ['Store', 'Sky', 'Tree'],
          correctAnswer: 'Store',
          hint: 'You go shopping there.',
          explanation: 'A store is a place where you buy things like food.',
          explanationAudioUrl: '/audio/vocab-s2-1-explanation.mp3',
          maxAttempts: 3,
          timeLimitSeconds: 25,
          feedback: {
            correct: 'Yes! You buy food at a store.',
            correctAudioUrl: '/audio/vocab-s2-1-correct.mp3',
            incorrect: 'Think about where people shop.',
            incorrectAudioUrl: '/audio/vocab-s2-1-incorrect.mp3',
          },
          position: 0,
        },
        {
          ...
          questionImageUrl: '/images/teacher.svg',
          questionAudioUrl: '/audio/vocab-s2-2-question.mp3',
          ...
          explanationAudioUrl: '/audio/vocab-s2-2-explanation.mp3',
          maxAttempts: 3,
          timeLimitSeconds: 30,
          feedback: {
            correct: 'Excellent! A teacher helps you learn.',
            correctAudioUrl: '/audio/vocab-s2-2-correct.mp3',
            incorrect: 'Try the word for someone who teaches.',
            incorrectAudioUrl: '/audio/vocab-s2-2-incorrect.mp3',
          },
          position: 1,
        },
        {
          ...
          questionImageUrl: '/images/family.svg',
          questionAudioUrl: '/audio/vocab-s2-3-question.mp3',
          correctAnswer: 'Mother',
          hint: 'Think of mom, dad, or sister.',
          explanation: 'Family members include mother, father, sister, and brother.',
          explanationAudioUrl: '/audio/vocab-s2-3-explanation.mp3',
          maxAttempts: 3,
          timeLimitSeconds: 35,
          feedback: {
            correct: 'Great! That\'s a family member.',
            correctAudioUrl: '/audio/vocab-s2-3-correct.mp3',
            incorrect: 'Try words like mother, father, or sister.',
            incorrectAudioUrl: '/audio/vocab-s2-3-incorrect.mp3',
          },
          position: 2,
        },
      ],
      ...
      interactions: [
        {
          ...
          questionImageUrl: '/images/eating.svg',
          questionAudioUrl: '/audio/vocab-s3-1-question.mp3',
          options: ['Eat', 'Fly', 'Sleep'],
          correctAnswer: 'Eat',
          hint: 'You do this when you are hungry.',
          explanation: 'Eat is the action of consuming food.',
          explanationAudioUrl: '/audio/vocab-s3-1-explanation.mp3',
          maxAttempts: 3,
          timeLimitSeconds: 25,
          feedback: {
            correct: 'Perfect! You eat food.',
            correctAudioUrl: '/audio/vocab-s3-1-correct.mp3',
            incorrect: 'Think about what you do with food.',
            incorrectAudioUrl: '/audio/vocab-s3-1-incorrect.mp3',
          },
          position: 0,
        },
        {
          ...
          questionImageUrl: '/images/walking.svg',
          questionAudioUrl: '/audio/vocab-s3-2-question.mp3',
          options: ['Walk', 'Think', 'Sing'],
          correctAnswer: 'Walk',
          hint: 'You move from one place to another.',
          explanation: 'Walk means to move by using your legs.',
          explanationAudioUrl: '/audio/vocab-s3-2-explanation.mp3',
          maxAttempts: 3,
          timeLimitSeconds: 30,
          feedback: {
            correct: 'Yes! You walk with your legs.',
            correctAudioUrl: '/audio/vocab-s3-2-correct.mp3',
            incorrect: 'Try the action that uses your legs.',
            incorrectAudioUrl: '/audio/vocab-s3-2-incorrect.mp3',
          },
          position: 1,
        },
        {
          ...
          questionImageUrl: '/images/reading-book.svg',
          questionAudioUrl: '/audio/vocab-s3-3-question.mp3',
          correctAnswer: 'Read',
          hint: 'You look at the words.',
          explanation: 'Read is the action of looking at and understanding written words.',
          explanationAudioUrl: '/audio/vocab-s3-3-explanation.mp3',
          maxAttempts: 3,
          timeLimitSeconds: 35,
          feedback: {
            correct: 'Great! You read a book.',
            correctAudioUrl: '/audio/vocab-s3-3-correct.mp3',
            incorrect: 'Try the word "read".',
            incorrectAudioUrl: '/audio/vocab-s3-3-incorrect.mp3',
          },
          position: 2,
        },
      ],
      ...
      interactions: [
        {
          ...
          questionImageUrl: '/images/two-apples.svg',
          questionAudioUrl: '/audio/num-s2-1-question.mp3',
          options: ['1', '2', '3'],
          correctAnswer: '2',
          hint: 'Count the apples carefully.',
          explanation: 'There are 2 apples.',
          explanationAudioUrl: '/audio/num-s2-1-explanation.mp3',
          maxAttempts: 3,
          timeLimitSeconds: 25,
          feedback: {
            correct: 'Perfect! There are 2 apples.',
            correctAudioUrl: '/audio/num-s2-1-correct.mp3',
            incorrect: 'Count again carefully.',
            incorrectAudioUrl: '/audio/num-s2-1-incorrect.mp3',
          },
          position: 0,
        },
        {
          ...
          questionImageUrl: '/images/four-stars.svg',
          questionAudioUrl: '/audio/num-s2-2-question.mp3',
          options: ['3', '4', '5'],
          correctAnswer: '4',
          hint: 'Count each star.',
          explanation: 'There are 4 stars, so the answer is 4.',
          explanationAudioUrl: '/audio/num-s2-2-explanation.mp3',
          maxAttempts: 3,
          timeLimitSeconds: 30,
          feedback: {
            correct: 'Excellent counting! 4 stars = 4.',
            correctAudioUrl: '/audio/num-s2-2-correct.mp3',
            incorrect: 'Count the stars one by one.',
            incorrectAudioUrl: '/audio/num-s2-2-incorrect.mp3',
          },
          position: 1,
        },
        {
          ...
          questionImageUrl: '/images/three-books.svg',
          questionAudioUrl: '/audio/num-s2-3-question.mp3',
          correctAnswer: '3',
          hint: 'Count each book.',
          explanation: 'There are 3 books.',
          explanationAudioUrl: '/audio/num-s2-3-explanation.mp3',
          maxAttempts: 3,
          timeLimitSeconds: 35,
          feedback: {
            correct: 'Great! You counted 3 books.',
            correctAudioUrl: '/audio/num-s2-3-correct.mp3',
            incorrect: 'Try counting again: 1, 2, 3.',
            incorrectAudioUrl: '/audio/num-s2-3-incorrect.mp3',
          },
          position: 2,
        },
      ],
      ...
      interactions: [
        {
          ...
          questionImageUrl: '/images/after-three.svg',
          questionAudioUrl: '/audio/num-s3-1-question.mp3',
          options: ['2', '4', '5'],
          correctAnswer: '4',
          hint: 'Count: 1, 2, 3, and then...',
          explanation: 'After 3 comes 4.',
          explanationAudioUrl: '/audio/num-s3-1-explanation.mp3',
          maxAttempts: 3,
          timeLimitSeconds: 25,
          feedback: {
            correct: 'Perfect! 4 comes after 3.',
            correctAudioUrl: '/audio/num-s3-1-correct.mp3',
            incorrect: 'Count forward: 3, 4.',
            incorrectAudioUrl: '/audio/num-s3-1-incorrect.mp3',
          },
          position: 0,
        },
        {
          ...
          questionImageUrl: '/images/four-five.svg',
          questionAudioUrl: '/audio/num-s3-2-question.mp3',
          correctAnswer: 'True',
          hint: 'Count: 4, 5.',
          explanation: 'Yes, 5 comes right after 4.',
          explanationAudioUrl: '/audio/num-s3-2-explanation.mp3',
          maxAttempts: 3,
          timeLimitSeconds: 25,
          feedback: {
            correct: 'Exactly! 5 follows 4.',
            correctAudioUrl: '/audio/num-s3-2-correct.mp3',
            incorrect: 'Count forward from 4.',
            incorrectAudioUrl: '/audio/num-s3-2-incorrect.mp3',
          },
          position: 1,
        },
        {
          ...
          questionImageUrl: '/images/after-two.svg',
          questionAudioUrl: '/audio/num-s3-3-question.mp3',
          correctAnswer: '3',
          hint: 'Count: 1, 2, 3.',
          explanation: 'The number after 2 is 3.',
          explanationAudioUrl: '/audio/num-s3-3-explanation.mp3',
          maxAttempts: 3,
          timeLimitSeconds: 35,
          feedback: {
            correct: 'Excellent! 3 comes after 2.',
            correctAudioUrl: '/audio/num-s3-3-correct.mp3',
            incorrect: 'Try counting: 2, 3.',
            incorrectAudioUrl: '/audio/num-s3-3-incorrect.mp3',
          },
          position: 2,
        },
      ],
